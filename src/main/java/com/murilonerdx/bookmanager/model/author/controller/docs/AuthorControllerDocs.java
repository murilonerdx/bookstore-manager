package com.murilonerdx.bookmanager.model.author.controller.docs;
  ...
  @ApiResponses(
      value =
      {
        ...
        , @ApiResponse(
              code = 400,
              message =
                  "Missing required fileds, wrong field range value or author already registered on system")
      })
  AuthorDTO
  ...
  @ApiResponses(value =
                {
                  ...
                  , @ApiResponse(code = 404,
                                 message = "Author not found error code")
                })
  AuthorDTO
  ...
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200,
                               message = "Return all registered authors")
                })
  List<AuthorDTO>
  findAll();
