package com.murilonerdx.bookmanager.model.publisher.controller.docs;
...
public interface PublisherControllerDocs {
  ...
  PublisherDTO
  create(@RequestBody @Valid PublisherDTO publisherDTO);

  @ApiOperation(value = "List all registered publishers")
  @ApiResponses(value =
                {
                  @ApiResponse(code = 200,
                               message = "Return all registered publishers")
                })
  List<PublisherDTO>
  findAll();
  ...
  @ApiResponses(value =
                {
                  ...
                  , @ApiResponse(code = 404,
                                 message = "Publisher not found error code")
                })
  PublisherDTO
