package com.murilonerdx.bookmanager.model.book.controller.docs;
...
public interface BookControllerDocs {
  ...
  BookResponseDTO
  create(AuthenticatedUser authenticatedUser, BookRequestDTO bookRequestDTO);
  ...
  BookResponseDTO
  findByIdAndUser(AuthenticatedUser authenticatedUser, Long id);
  ...
  @ApiResponses(value =
                {
                  @ApiResponse(
                      code = 200,
                      message =
                          "Book list found by authenticated user informed")
                })
  ...
  BookResponseDTO
  updateByUser(AuthenticatedUser authenticatedUser, Long bookId,
  ...
  @ApiResponses(value =
                {
                  @ApiResponse(code = 204,
                               message = "Book by user successfully deleted")
                  ,
                      @ApiResponse(code = 404, message = "Book not found error")
                })
  void
  deleteByIdAndUser(AuthenticatedUser authenticatedUser, Long bookId);
}
